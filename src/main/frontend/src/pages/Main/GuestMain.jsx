          ...
          <div className="banner2">
            <div className="banner2-box">
              ...
              <div className="banner2-content">
                <div
                  className="banner2-mainText"
                  {...useScrollFadeIn("up", 1, 0.5, 1)}
                >
                  <div>알바비는 오르지 않고</div>
                  <div>투자를 하기엔 어려우셨나요?</div>
                </div>
                <div
                  className="banner2-subText"
                  {...useScrollFadeIn("up", 1, 0.75, 1)}
                >
          ...
          <div className="banner3">
            <div className="banner3-box">
              <div className="banner3-title">
                <div
                  className="banner3-subTitle"
                  {...useScrollFadeIn("up", 1, 0)}
                >
                  여러분의 돈은 걱정하지 마세요
                </div>
                <div
                  className="banner3-mainTitle"
                  {...useScrollFadeIn("up", 1, 0.25)}
                >
                ...
                <div className="banner3-content">
                  <div className="banner3-first">
                    <div className="banner3-coin">
                      <MainCoin
                        className="banner3-coinImage"
                        {...useScrollFadeIn("left", 1, 0.75)}
                      />
                      <div {...useScrollFadeIn("down", 1, 1.25)}>
                        * 5 스톡이 입금 되었습니다.
                      </div>
                    </div>
                    <div
                      className="banner3-coinText"
                    ...
                    >
                      ...
                      <div className="banner3-coinSubtitle">
                        가상의 코인으로 마음껏 연습하세요
                      </div>
                    </div>
                  </div>
          ...
          <div className="banner4">
            <div className="banner4-box">
              <div className="banner4-title">
                <div
                  className="banner4-mainTitle"
                  {...useScrollFadeIn("up", 1, 0)}
                >
                  모의 투자라 도움이 안 될 거 같나요?
                </div>
                <div
                  className="banner4-subTitle"
                  {...useScrollFadeIn("up", 0.5, 0.25)}
                >
                  <div>실제 상장의 정보로</div>
              ...
              <div className="banner4-content">
                <div
                  className="banner4-top"
                  {...useScrollFadeIn("up", 1, 0.75)}
                >
                  실시간 TOP 5
                </div>
                {topItem}
